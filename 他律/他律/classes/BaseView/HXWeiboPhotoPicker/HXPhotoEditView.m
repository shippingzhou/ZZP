...
//    UIBezierPath *circlePath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(width / 2, height / 2) radius:(width - 20) / 2 startAngle:0 endAngle:M_PI * 2 clockwise:YES];
    UIBezierPath *rectPath = [UIBezierPath bezierPathWithRect:CGRectMake(0, (height - width)/2, width, width)];
    ...
    CGContextAddRect(context, CGRectMake(0, (height - width)/2, width, width));
