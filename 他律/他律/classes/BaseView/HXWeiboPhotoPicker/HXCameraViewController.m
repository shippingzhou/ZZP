...
- (UIView *)moveView
{
    if (!_moveView) {
        ...
        [changePhotoBtn setTitle:@"photo" forState:UIControlStateNormal];
        ...
        [changeVideoBtn setTitle:@"video" forState:UIControlStateNormal];
...
- (void)nextClick
{
    ...
    if (self.changePhotoBtn.selected) {
        ...
        [self.playerLayer.player pause];
        __weak typeof(self) weakSelf = self;
        [self.view showLoadingHUDText:@"Processing"];
        ...
        [self clipVideoCompleted:^{
            ...
            weakSelf.view.userInteractionEnabled = YES;
            [weakSelf.view handleLoading];
            [weakSelf.view showImageHUDText:@"Processing failed, please try again!"];
        }];
