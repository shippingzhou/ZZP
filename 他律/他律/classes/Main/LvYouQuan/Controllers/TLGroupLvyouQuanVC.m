...
@interface TLGroupLvyouQuanVC ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation TLGroupLvyouQuanVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TLNewestLvyouQuanCell *cell = [TLNewestLvyouQuanCell cellWithTableView:tableView withIdentifer:@"groupId"];
...
-(void)getData {
    ...
    NSDictionary *dict1 = @{
                            ...
                            @"content": @"过去的行为决定了我们当下的处境过去的行为决定了我们当下的处境过去的行为决定了我们当下的处境",
                            @"imgs": @"",
                            @"isRead": @"1",
                            @"isComment": @"0",
                            @"isCollect": @"0",
