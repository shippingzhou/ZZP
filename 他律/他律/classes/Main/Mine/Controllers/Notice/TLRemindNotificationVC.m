...
@interface TLRemindNotificationVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation TLRemindNotificationVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if ([self.showStr isEqualToString:@"show"]) {
        TLNoNotionficationCell *cell = [TLNoNotionficationCell cellWithTableView:tableView withIdentifer:@"noRemindId"];
        cell.title = @"暂无关注&提醒消息";
        return cell;
    }
    TLRemindNotificationCell *cell = [TLRemindNotificationCell cellWithTableView:tableView withIdentifer:@"myRemindId"];
