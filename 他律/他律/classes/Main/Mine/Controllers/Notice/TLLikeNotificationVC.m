...
@interface TLLikeNotificationVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation TLLikeNotificationVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if ([self.showStr isEqualToString:@"show"]) {
        TLNoNotionficationCell *cell = [TLNoNotionficationCell cellWithTableView:tableView withIdentifer:@"noLikeId"];
        cell.title = @"暂无点赞消息";
        return cell;
    }
    TLLikeNotificationCell *cell = [TLLikeNotificationCell cellWithTableView:tableView withIdentifer:@"myPlansId"];
